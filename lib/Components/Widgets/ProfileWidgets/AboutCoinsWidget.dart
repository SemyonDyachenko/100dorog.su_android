              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    padding: EdgeInsets.only(top: 20, left: 20, right: 20),
                    child: Text(
                        "Бонусы 100 DOROG начисляются каждый раз при оплате тура в размере 7 % от стоимости тура.При оплате бронирования можно использовать количество бонусов, не превышающее 30 % стоимости тура.Бонусы не начисляются если действует акция или специальное предложение."),
                  )
                ],
              ),
            ),
